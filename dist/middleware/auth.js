  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          key = process.env.JWT_PRIVATEKEY;
          _context.prev = 1;
          if (!tokenFromHeader(req)) {
            _context.next = 12;
            break;
          }
          decoded = _jsonwebtoken["default"].verify(tokenFromHeader(req), key);
          ...
          break;
        case 9:
          return _context.abrupt("return", res.status(403).json('You are not authorized to do this'));
        case 10:
          _context.next = 13;
          break;
        case 12:
          return _context.abrupt("return", res.status(401).json('Token is valid'));
        case 13:
          _context.next = 18;
          break;
        case 15:
